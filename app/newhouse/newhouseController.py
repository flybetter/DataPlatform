...
@newhouses.route("/<string:phone>/<string:city>/<int:num>", methods=['GET'])
def index(phone, num, city):
...
@newhouses.route("/<string:phone>/<string:city>/<int:num>/detail", methods=['GET'])
def detail(phone, num, city):
    ...
    if m == secret:
        ...
        return render_template("newhouse/newhouseDetail.html", count=count, avg_price=avg_price, area=area,
